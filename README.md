This repository contains the **F3D** CAD and **STEP** files for 3D printing a test jig to test for acid residues in the activated carbon used to filter the printing fumes.
